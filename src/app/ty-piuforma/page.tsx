...
import {
  ...
  ShieldCheck, Banknote, Home, ChevronRight, Flame, Zap,
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <Link href="/piuforma" className="hover:text-brand-primary">+Forma</Link>
            <ChevronRight className="w-4 h-4" />
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-3xl p-8 md:p-10 text-center shadow-xl mb-8 animate-fade-in">
          ...
          <p className="text-lg md:text-xl opacity-95">
            {customerName ? (
              <>Grazie <strong>{customerName}</strong>! Il tuo ordine di <strong>+Forma</strong> è stato ricevuto con successo</>
            ) : (
              <>Il tuo ordine di <strong>+Forma</strong> è stato ricevuto con successo</>
            )}
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-orange-300 rounded-2xl p-6 md:p-8 mb-8 text-center relative overflow-hidden">
          ...
          <p className="text-lg text-gray-700 font-medium mb-3">
            Un nostro operatore ti chiamerà nei prossimi minuti
          </p>
          <p className="text-gray-600">
            Assicurati che il telefono sia acceso e con la suoneria attiva.<br />
            La conferma del tuo ordine sarà rapida e semplice.
          </p>
        </div>

        {/* ORDER DETAILS */}
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          <h2 className="text-xl md:text-2xl font-black text-brand-dark mb-6 flex items-center gap-3">
            <Package className="w-7 h-7 text-brand-primary" />
            Riepilogo del tuo Ordine
          </h2>

          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 border-2 border-brand-primary/30 rounded-xl p-5 flex flex-col sm:flex-row items-center gap-5">
            ...
            <div className="flex-1 text-center sm:text-left">
              <h3 className="font-bold text-brand-dark text-lg md:text-xl">+Forma Metabolismo Attivo</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-6">
            <div className="bg-gray-50 rounded-xl p-4 flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-brand-dark">Spedizione Gratuita</p>
            ...
            <div className="bg-gray-50 rounded-xl p-4 flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-brand-dark">Pagamento alla Consegna</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          ...
          <div className="relative pl-8 space-y-8">
            {/* Timeline line */}
            <div className="absolute left-3 top-2 bottom-2 w-0.5 bg-gradient-to-b from-green-500 via-brand-primary to-gray-200" />
            ...
            <div className="relative">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                ...
                <p className="text-gray-600 mt-1">
                  Un operatore ti contatterà per confermare l'ordine e i dati di spedizione.
            ...
            {/* Step 2 */}
            <div className="relative">
              <div className="absolute -left-8 w-6 h-6 bg-brand-primary rounded-full flex items-center justify-center ring-4 ring-orange-100">
                <span className="text-white text-xs font-bold">2</span>
              </div>
              <div>
                <h3 className="font-bold text-brand-dark text-lg">Preparazione Spedizione (24h)</h3>
                <p className="text-gray-600 mt-1">
                  Dopo la conferma, prepariamo il tuo +Forma con cura per la spedizione.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div>
                <h3 className="font-bold text-brand-dark text-lg">Consegna a Casa Tua (24-48h)</h3>
                <p className="text-gray-600 mt-1">
            ...
            <div className="relative">
              ...
              <div>
                <h3 className="font-bold text-brand-dark text-lg">Inizia il tuo Percorso!</h3>
                <p className="text-gray-600 mt-1">
                  Prendi 2 compresse al giorno e inizia a sentirti più leggero ed energico.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
              <div className="h-full w-1/4 bg-gradient-to-r from-green-500 to-brand-primary rounded-full animate-pulse" />
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          <h2 className="text-xl md:text-2xl font-black text-brand-dark mb-6 flex items-center gap-3">
            ...
            Perché Hai Scelto +Forma
          </h2>

          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              <Flame className="w-10 h-10 text-brand-primary mx-auto mb-3" />
              <h3 className="font-bold text-brand-dark mb-1">Brucia Calorie</h3>
              <p className="text-sm text-gray-600">Riattiva il metabolismo anche a riposo</p>
            </div>
            <div className="bg-green-50 border border-green-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-brand-dark mb-1">100% Naturale</h3>
              <p className="text-sm text-gray-600">Ingredienti vegetali certificati</p>
            </div>
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-brand-dark mb-1">Più Energia</h3>
              <p className="text-sm text-gray-600">Vitalità durante tutta la giornata</p>
            </div>
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-brand-dark mb-1">Benessere</h3>
              <p className="text-sm text-gray-600">Meno gonfiore, più leggerezza</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-green-500">
              <h3 className="font-bold text-brand-dark mb-2">Quando riceverò la chiamata?</h3>
              <p className="text-gray-600">
                Il nostro team ti contatterà entro <strong>30 minuti</strong> durante l'orario lavorativo (9:00 - 20:00).
                Se non sei raggiungibile, riproveremo più volte.
              </p>
            </div>

            <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-green-500">
              <h3 className="font-bold text-brand-dark mb-2">E se non riesco a rispondere?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-green-500">
              <h3 className="font-bold text-brand-dark mb-2">Quando riceverò +Forma?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-green-500">
              <h3 className="font-bold text-brand-dark mb-2">Quanto pagherò esattamente?</h3>
              <p className="text-gray-600">
                Il prezzo finale è <strong>{orderPrice}</strong> (spedizione inclusa). Paghi in contanti al corriere alla consegna.
              </p>
            </div>

            <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-green-500">
              <h3 className="font-bold text-brand-dark mb-2">Posso modificare o annullare l'ordine?</h3>
              <p className="text-gray-600">
                Sì, puoi farlo durante la chiamata di conferma oppure contattando il nostro servizio clienti.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 text-center border border-green-200">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Stai per iniziare il tuo percorso verso una forma migliore.<br />
            Il nostro team è pronto ad assisterti in ogni momento.
          </p>
