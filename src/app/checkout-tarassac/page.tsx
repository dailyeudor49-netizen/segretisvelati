...
const ProgressStep = memo(({ number, label, status }: {
  ...
  const getStepStyles = () => {
    switch (status) {
      ...
      case 'active':
        return { circle: 'bg-red-600 text-white', text: 'text-red-600 font-bold', line: 'bg-gray-200' }
      default:
  ...
  <div>
    ...
    <div className="flex">
      ...
      <input
        ...
        inputMode={inputMode}
        maxLength={maxLength}
        className={`w-full p-4 md:p-5 bg-gray-50 border-2 ${error ? 'border-red-500' : 'border-gray-200'} ${prefix ? 'rounded-r-xl' : 'rounded-xl'} focus:border-red-600 focus:bg-white text-lg md:text-xl transition-all touch-manipulation`}
    ...
    <div className="p-5 md:p-6">
      ...
      <div className="flex gap-4 pb-5 border-b border-gray-100">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-gray-900 text-lg">Tarassac Slim</h3>
          <p className="text-base text-gray-500">2 Confezioni (2 mesi)</p>
          <p className="text-base text-green-600 font-bold mt-1">Offerta Speciale 2x1</p>
        </div>
      </div>
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="flex items-center gap-3 text-base text-gray-700 bg-red-50 p-4 rounded-xl">
...
export default function TarassacCheckout() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b-2 border-gray-200 py-4 shadow-sm">
        <div className="max-w-4xl mx-auto px-4 flex items-center justify-between">
          <Link
            href="/tarassac-feg"
            className="flex items-center gap-2 text-gray-600 hover:text-red-600 transition-colors py-2 touch-manipulation"
          >
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="p-5 md:p-6 space-y-6" noValidate>
                  ...
                  <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-5 mb-2">
                    ...
                    <ol className="text-base md:text-lg text-gray-700 space-y-3">
                      <li className="flex items-start gap-3">
                        <span className="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">1</span>
                        <span>Compili questo modulo con i tuoi dati</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">2</span>
                  ...
                  <button
                    ...
                    className="w-full bg-red-600 hover:bg-red-700 active:bg-red-800 disabled:bg-gray-400 text-white font-black text-xl md:text-2xl py-5 md:py-6 rounded-2xl shadow-lg transition-all disabled:cursor-not-allowed flex items-center justify-center gap-3 touch-manipulation min-h-[72px]"
                  >
                    {isSubmitting ? (
                      <>
