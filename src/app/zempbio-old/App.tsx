                 ...
                 <div className="w-full md:w-1/3 shrink-0">
                    <div className="grid grid-cols-2 gap-3 mb-6">
                      <div className="aspect-[3/4] bg-gray-200 overflow-hidden border-2 border-gray-300 relative">
                         <div className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-gray-400 uppercase">Foto Prima</div>
                      </div>
                      <div className="aspect-[3/4] bg-gray-200 overflow-hidden border-4 border-emerald-500 relative">
                         <div className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-gray-400 uppercase">Foto Dopo</div>
                      </div>
                    </div>
                    <div>
