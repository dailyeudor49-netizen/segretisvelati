...
import {
  ...
  ShieldCheck, Banknote, Home, ChevronRight, Moon, Zap,
  Heart, Star, MessageCircle, HelpCircle, Flame
} from 'lucide-react'

export default function ThankYouMenobalancePage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && (window as typeof window & { fbq?: (...args: unknown[]) => void }).fbq) {
      (window as typeof window & { fbq: (...args: unknown[]) => void }).fbq('track', 'Purchase', {
        value: 49.99,
        currency: 'EUR',
        content_name: 'MenoBalance Protocollo',
        content_type: 'product',
        content_ids: ['menobalance-protocollo'],
        num_items: 1
      })
    }
  }, [])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              <span className="text-2xl font-black text-purple-600">MenoBalance</span>
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 py-3">
          <nav className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <Link href="/menobalance-system" className="hover:text-purple-600">MenoBalance</Link>
            <ChevronRight className="w-4 h-4" />
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        {/* SUCCESS BANNER */}
        <div className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-3xl p-8 md:p-10 text-center shadow-xl mb-8 animate-fade-in">
          <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
            <Check className="w-12 h-12 text-purple-500" strokeWidth={3} />
          </div>
          ...
          <p className="text-lg md:text-xl opacity-95">
            {customerName ? (
              <>Grazie <strong>{customerName}</strong>! Il tuo ordine di <strong>MenoBalance Protocollo</strong> e stato ricevuto con successo</>
            ) : (
              <>Il tuo ordine di <strong>MenoBalance Protocollo</strong> e stato ricevuto con successo</>
            )}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border-2 border-purple-200 rounded-xl p-5 flex flex-col sm:flex-row items-center gap-5">
            <div className="w-24 h-24 bg-white rounded-xl p-2 border border-gray-200 flex-shrink-0">
              <img
                ...
                alt="MenoBalance Protocollo"
                className="w-full h-full object-contain"
              />
            </div>
            <div className="flex-1 text-center sm:text-left">
              <h3 className="font-bold text-gray-900 text-lg md:text-xl">MenoBalance Protocollo</h3>
              <p className="text-gray-500">Kit Giorno + Notte - Trattamento 1 mese</p>
              ...
              <p className="text-green-600 font-medium text-sm mt-1 flex items-center gap-1 justify-center sm:justify-start">
                <Check className="w-4 h-4" /> Sconto 50% applicato
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          ...
          <div className="relative pl-8 space-y-8">
            <div className="absolute left-3 top-2 bottom-2 w-0.5 bg-gradient-to-b from-green-500 via-purple-600 to-gray-200" />
            ...
            <div className="relative">
              <div className="absolute -left-8 w-6 h-6 bg-purple-600 rounded-full flex items-center justify-center ring-4 ring-purple-100">
                <span className="text-white text-xs font-bold">2</span>
              </div>
              <div>
                <h3 className="font-bold text-gray-900 text-lg">Preparazione Spedizione (24h)</h3>
                <p className="text-gray-600 mt-1">
                  Dopo la conferma, prepariamo il tuo MenoBalance Protocollo con cura per la spedizione.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Prendi MenoBalance Giorno e Notte quotidianamente e inizia a sentire la differenza sul tuo metabolismo.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
              <div className="h-full w-1/4 bg-gradient-to-r from-green-500 to-purple-600 rounded-full animate-pulse" />
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          <h2 className="text-xl md:text-2xl font-black text-gray-900 mb-6 flex items-center gap-3">
            ...
            Perche Hai Scelto MenoBalance
          </h2>

          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              <Zap className="w-10 h-10 text-yellow-600 mx-auto mb-3" />
              <h3 className="font-bold text-gray-900 mb-1">Formula Giorno</h3>
              <p className="text-sm text-gray-600">Berberina per attivare il metabolismo</p>
            </div>
            <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              <Moon className="w-10 h-10 text-indigo-600 mx-auto mb-3" />
              <h3 className="font-bold text-gray-900 mb-1">Formula Notte</h3>
              <p className="text-sm text-gray-600">Melatonina e valeriana per il sonno</p>
            </div>
            <div className="bg-red-50 border border-red-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              <Flame className="w-10 h-10 text-red-600 mx-auto mb-3" />
              <h3 className="font-bold text-gray-900 mb-1">Brucia Grassi</h3>
              <p className="text-sm text-gray-600">Scioglie il grasso addominale</p>
            </div>
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-5 text-center hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Ingredienti clinicamente testati</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-5 border-l-4 border-purple-500">
              <h3 className="font-bold text-gray-900 mb-2">Quando ricevero MenoBalance?</h3>
              <p className="text-gray-600">
        ...
        {/* CONTACT */}
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-6 md:p-8 mb-8 text-center border border-purple-200">
          <h2 className="text-xl font-black text-purple-800 mb-4 flex items-center justify-center gap-2">
          ...
          <div className="space-y-3 text-gray-700">
            ...
            <p className="flex items-center justify-center gap-2">
              ...
              <strong>Email:</strong> <a href="mailto:assistenza@healthnews.it" className="text-purple-600 hover:underline">assistenza@healthnews.it</a>
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 text-center border border-purple-200">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Stai per iniziare il tuo percorso verso un metabolismo attivo e notti serene.<br />
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 mt-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-white font-bold text-xl mb-2">MenoBalance Protocollo</p>
          <p className="text-sm mb-3">Il tuo alleato naturale per la menopausa</p>
          <p className="text-xs text-gray-500 mb-3">
            <strong className="text-gray-400">Health News Network</strong> - P.IVA IT12345678901
          </p>
          ...
          <p className="text-xs text-gray-600 mt-3">
            © 2025 Health News Network - Tutti i diritti riservati.
          </p>
        </div>
      </footer>
    </div>
